...
public class HttpUtil {
    ...
    public static void addition(final int id,final String title,final String content,final int type,final String address,final first_first_fragment.HttpCallbackListener listener){
        final Map<String,Object> map = new LinkedHashMap<String,Object>();
        map.put("news_id",id);
        map.put("news_title",title);
        map.put("news_conten",content);
